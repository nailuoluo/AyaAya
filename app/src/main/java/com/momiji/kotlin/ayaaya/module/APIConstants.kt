...
const val OAUTH2_ACCESS_TOKEN = "oauth2/access_token"

// User / Account
const val GET_UID = "account/get_uid.json"
const val USER_SHOW = "users/show.json"

// Statuses
const val HOME_TIMELINE = "statuses/home_timeline.json"
const val USER_TIMELINE = "statuses/user_timeline.json"
const val BILATERAL_TIMELINE = "statuses/bilateral_timeline.json"
const val MENTIONS = "statuses/mentions.json"
const val REPOST_TIMELINE = "statuses/repost_timeline.json"
const val UPDATE = "statuses/update.json"
const val UPLOAD = "statuses/upload.json"
const val REPOST = "statuses/repost.json"
const val DESTROY = "statuses/destroy.json"
const val UPLOAD_PIC = "statuses/upload_pic.json"
const val UPLOAD_URL_TEXT = "statuses/upload_url_text.json"
const val QUERY_ID = "statuses/queryid.json"
const val QUERY_MID = "statuses/querymid.json"
const val SHOW = "statuses/show.json"

// Comments
const val COMMENTS_TIMELINE = "comments/timeline.json"
const val COMMENTS_MENTIONS = "comments/mentions.json"
const val COMMENTS_TO_ME = "comments/to_me.json"
const val COMMENTS_SHOW = "comments/show.json"
const val COMMENTS_CREATE = "comments/create.json"
const val COMMENTS_REPLY = "comments/reply.json"
const val COMMENTS_DESTROY = "comments/destroy.json"

// Favorites
const val FAVORITES_CREATE = "favorites/create.json"
const val FAVORITES_DESTROY = "favorites/destroy.json"
const val FAVORITES_LIST = "favorites.json"

// Search
const val SEARCH_TOPICS = "search/topics.json"
const val SEARCH_STATUSES = "search/statuses.json"
const val SEARCH_USERS = "search/users.json"
const val SEARCH_SUGGESTIONS_AT_USERS = "search/suggestions/at_users.json"

// Friendships
const val FRIENDSHIPS_FRIENDS = "friendships/friends.json"
const val FRIENDSHIPS_FOLLOWERS = "friendships/followers.json"
const val FRIENDSHIPS_CREATE = "friendships/create.json"
const val FRIENDSHIPS_DESTROY = "friendships/destroy.json"
const val FRIENDSHIPS_GROUPS = "friendships/groups.json"
const val FRIENDSHIPS_GROUPS_IS_MEMBER = "friendships/groups/is_member.json"
const val FRIENDSHIPS_GROUPS_TIMELINE = "friendships/groups/timeline.json"
const val FRIENDSHIPS_GROUPS_CREATE = "friendships/groups/create.json"
const val FRIENDSHIPS_GROUPS_DESTROY = "friendships/groups/destroy.json"
const val FRIENDSHIPS_GROUPS_MEMBERS_ADD = "friendships/groups/members/add.json"
const val FRIENDSHIPS_GROUPS_MEMBERS_DESTROY = "friendships/groups/members/destroy.json"

// Direct Message
const val DIRECT_MESSAGES = "direct_messages.json"
const val DIRECT_MESSAGES_USER_LIST = "direct_messages/user_list.json"
const val DIRECT_MESSAGES_CONVERSATION = "direct_messages/conversation.json"
const val DIRECT_MESSAGES_SEND = "direct_messages/new.json"
...
// Attitude
const val ATTITUDE_CREATE = "attitudes/create.json"
const val ATTITUDE_DESTROY = "attitudes/destroy.json"

// Short Url
const val SHORT_URL_SHORTEN = "short_url/shorten.json"
const val SHORT_URL_EXPAND = "short_url/expand.json"
